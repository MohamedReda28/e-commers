...
class NavigatBarIem extends StatelessWidget {
  const NavigatBarIem({super.key, required this.isActive, required this.bottonNavigtionarEntite});
  final bool isActive;
  final BottonNavigtionarEntite bottonNavigtionarEntite;
  @override
  Widget build(BuildContext context) {
    return isActive ? ActiveItem(image:bottonNavigtionarEntite.activeImage,

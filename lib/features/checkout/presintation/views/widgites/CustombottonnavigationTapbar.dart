...
class CustombottonnavigationTapbar extends StatelessWidget {
  const CustombottonnavigationTapbar({super.key, required this.currentPageActive, required this.pageController,});
        ...
        return Expanded(
          ...
          child: GestureDetector(
            onTap: (){
              ...
              child: NavigatTapBarItem(isActive: index <=currentPageActive , bottonTapBarEntity: entity,)),
        );
      }).toList(),

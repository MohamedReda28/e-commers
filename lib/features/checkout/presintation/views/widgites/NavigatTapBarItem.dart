...
class NavigatTapBarItem extends StatelessWidget {
  const NavigatTapBarItem({super.key, required this.isActive, required this.bottonTapBarEntity});
  final bool isActive;
  final BottonTapBarEntity bottonTapBarEntity;
  @override
  Widget build(BuildContext context) {
    return AnimatedCrossFade(
        firstChild: ActiveStepItem(title:bottonTapBarEntity.title,),
        secondChild: InActiveStepItem(numder:bottonTapBarEntity.InActivenum, title: bottonTapBarEntity.title),
